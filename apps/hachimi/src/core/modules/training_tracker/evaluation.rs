...
//! ```
//!
//! `gradeValue` + role + unique flag come from [`crate::core::modules::training_tracker::eval_data`]; the stat curve
...
use crate::core::modules::training_tracker::eval_data::{self, SkillGrade};
use crate::core::modules::training_tracker::memory_reader::AcquiredSkillInfo;
...
mod tests {
    ...
    fn validated_runners_match_exactly() {
        ...
        let resource = std::fs::read(format!(
            "{manifest}/src/core/modules/training_tracker/assets/skill_grades.json"
        ))
