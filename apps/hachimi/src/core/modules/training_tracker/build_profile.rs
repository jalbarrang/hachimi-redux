...
//! source of truth (`crate::core::modules::training_tracker::stat_targets` is now a thin façade over the active
//! profile's `per_stat_target`).
//!
//! - The closed-form [`crate::core::modules::training_tracker::cm_model`] supplies *threshold-aware marginal
...
//!
//! In-memory state only; persistence lives in [`crate::core::modules::training_tracker::config`]. Every persisted
...
use crate::core::modules::training_tracker::cm_model::{GroundCondition, Strategy};
use crate::core::modules::training_tracker::race_context::{Season, TimeOfDay, Weather};
...
pub struct BuildProfile {
    ...
    /// Target CM course id (key into `crate::core::modules::training_tracker::course_data`); `0` ⇒ none chosen.
    #[serde(default)]
