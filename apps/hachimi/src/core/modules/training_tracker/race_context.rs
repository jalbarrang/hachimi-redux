...
//! the build profile — but [`crate::core::modules::training_tracker::cm_model`] ignores them. Only the course
//! (distance/surface) and the [`crate::core::modules::training_tracker::cm_model::GroundCondition`] drive scoring.
//!
...
//! [`crate::core::modules::training_tracker::ui::icons`].
