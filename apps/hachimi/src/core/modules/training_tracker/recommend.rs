...
//! the L1 settings page and persisted by `crate::core::modules::training_tracker::config`); the scoring functions
...
use crate::core::modules::training_tracker::build_profile::Objective;
use crate::core::modules::training_tracker::cm_model::{
    self, Aptitudes, CourseParams, GroundCondition, StatKind, Strategy, Surface,
};
use crate::core::modules::training_tracker::evaluation::{self, stat_score};
use crate::core::modules::training_tracker::stat_targets;
...
/// `training_config.json` (see `crate::core::modules::training_tracker::config`).
...
/// Replace the parameters (clamped to sane ranges). Call [`crate::core::modules::training_tracker::config::persist`]
...
/// inputs. Built by the UI from the active [`crate::core::modules::training_tracker::build_profile`] + the target
