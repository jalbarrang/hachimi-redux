...
pub fn dump_skill_classes() {
    ...
    if let Some((list_ptr, count)) = crate::core::modules::training_tracker::memory_reader::read_acquired_skill_list() {
...
pub fn dump_live_skill_tags() {
    let entries = crate::core::modules::training_tracker::skill_shop::read_skill_shop();
    if entries.is_empty() {
