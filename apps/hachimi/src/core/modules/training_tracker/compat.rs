...
//!
//! The tracker's source moved in almost verbatim: `crate::core::modules::training_tracker::compat::X` simply
//! became `crate::core::modules::training_tracker::compat::X`. The only behavioural
...
/// Host API version, mirroring [`crate::core::modules::training_tracker::compat::ApiVersion`]. In-core every
...
/// In-core stand-in for `crate::core::modules::training_tracker::compat::Sdk`: a stateless façade over host
