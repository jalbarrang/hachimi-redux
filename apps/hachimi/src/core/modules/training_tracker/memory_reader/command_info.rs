...
pub struct CommandInfo {
    ...
    /// [`crate::core::modules::training_tracker::planner::near_rainbow_pressure`]). Drives the multi-turn bond
...
unsafe fn read_training_horses(ti: *mut c_void) -> Vec<(i32, f32, bool)> {
    ...
    unsafe {
        ...
        for i in 0..count {
            ...
            out.push((
                target_id,
                crate::core::modules::training_tracker::planner::near_rainbow_pressure(bond),
                is_guest,
            ));
        }
        out
