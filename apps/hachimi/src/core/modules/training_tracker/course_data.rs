...
//! thresholds, used to parameterize the [`crate::core::modules::training_tracker::cm_model`] survival/threshold
...
//! per game version without rebuilding. Mirrors [`crate::core::modules::training_tracker::eval_data`].
...
use crate::core::modules::training_tracker::cm_model::CourseParams;
...
pub fn course_label(course_id: i32) -> Option<String> {
    ...
    let surface = match c.surface {
        crate::core::modules::training_tracker::cm_model::Surface::Turf => "Turf",
        crate::core::modules::training_tracker::cm_model::Surface::Dirt => "Dirt",
    };
    Some(format!(
        "{} · {}m {}",
...
mod tests {
    use super::*;
    use crate::core::modules::training_tracker::cm_model::{StatKind, Surface};
    ...
    fn shipped_asset_parses() {
        let path = concat!(
            ...
            "/src/core/modules/training_tracker/assets/course_params.json"
        );
