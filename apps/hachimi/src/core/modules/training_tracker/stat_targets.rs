...
//! ([`crate::core::modules::training_tracker::build_profile`]), which owns the per-stat targets so they switch
...
//! settings editor) keep working; persistence is owned by [`crate::core::modules::training_tracker::config`].

use crate::core::modules::training_tracker::build_profile;
