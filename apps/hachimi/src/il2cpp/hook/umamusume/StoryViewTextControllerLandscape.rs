...
// NOTE: `SetLineSpacing` was removed from this class in the post-update version,
// so the line-spacing multiplier feature is no longer available here. Only
// `SetFontSize` remains hookable.
