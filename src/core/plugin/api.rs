...
use crate::{
    ...
    il2cpp::{
        self,
        types::{
            il2cpp_array_size_t, FieldInfo, Il2CppArray, Il2CppClass, Il2CppImage, Il2CppMethodPointer, Il2CppObject,
            Il2CppThread, Il2CppTypeEnum, MethodInfo,
        },
    },
};
...
unsafe extern "C" fn interceptor_get_trampoline_addr(this: *const Interceptor, hook_addr: *mut c_void) -> *mut c_void {
    // SAFETY: FFI / raw pointer operation required by IL2CPP interop
    unsafe { (*this).get_trampoline_addr(hook_addr as _) as _ }
}
...
unsafe extern "C" fn il2cpp_get_method_addr(
    ...
    // SAFETY: FFI / raw pointer operation required by IL2CPP interop
    unsafe { il2cpp::symbols::get_method_addr(class, CStr::from_ptr(name), args_count) as _ }
}
...
unsafe extern "C" fn il2cpp_get_method_addr_cached(
    ...
    // SAFETY: FFI / raw pointer operation required by IL2CPP interop
    unsafe { il2cpp::symbols::get_method_addr_cached(class, CStr::from_ptr(name), args_count) as _ }
}
...
unsafe extern "C" fn il2cpp_object_new(klass: *const Il2CppClass) -> *mut Il2CppObject {
    il2cpp::api::il2cpp_object_new(klass)
}
...
unsafe extern "C" fn il2cpp_get_singleton_like_instance(class: *mut Il2CppClass) -> *mut Il2CppObject {
    il2cpp::symbols::SingletonLike::new(class).map_or(0 as _, |s| s.instance())
}
